...
const FullScreenNav = () => {
  ...
  return (
    <div className=" full text-white hidden overflow-hidden absolute z-50 h-screen w-full ">
      <div className="h-screen w-full fixed ">
           <div className="h-full flex w-full">
        <div className="stairing h-full w-1/6 bg-red-900"></div>
        <div className="stairing h-full w-1/6 bg-red-900"></div>
        <div className="stairing h-full w-1/6 bg-red-900"></div>
        <div className="stairing h-full w-1/6 bg-red-900"></div>
        <div className="stairing h-full w-1/6 bg-red-900"></div>
      ...
      <div ref={fullNavLinkRef} className="relative">
        <div className=" flex justify-between  w-full items-start h-30">
