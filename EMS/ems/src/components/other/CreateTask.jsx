...
const CreateTask = () => {
  return (
    <form className="flex items-start gap-5 justify-between p-20  bg-gray-300 rounded-xl">
        <div className="">
      ...
      <div className="items-center">
        ...
        <textarea className="w-full p-5 h-50 rounded-md border-2 border-gray-500 mt-5 outline-none"
